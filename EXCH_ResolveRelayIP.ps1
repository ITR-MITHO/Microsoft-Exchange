...
$Data = Get-ExchangeServer | Get-MessageTrackingLog -ResultSize Unlimited -Start (Get-Date).AddDays(-30) -EventId Receive | 
    Select-Object Sender, @{Name='Recipients';Expression={$_.Recipients}}, OriginalClientIP
...
Write-Host "Completed, your export can be found here: $home\Desktop\ClientIP_Resolution.csv" -ForegroundColor Green
