...
| **Decomission Exchange** | [Decomission the last Exchange Server](https://learn.microsoft.com/en-us/exchange/hybrid-deployment/decommission-last-exchange-server) |
...
| **MFA Loop** | `while ($true) {Start-ManagedFolderAssistant mailbox@domain.com; Start-Sleep -Seconds 900}` |
...
| **Allow Outlook to use Exchange Online Autodiscover** | `HKEY_CURRENT_USER\Software\Microsoft\Office\16.0\Outlook\AutoDiscover` | `ExcludeExplicitO365Endpoint` | `0` |
